...
#   opponent_status         6
#   special_case            2
#   active_features        38   [hp(1), status(1), type1_onehot(18), type2_onehot(18)]
#   opp_active_features    38   [hp(1), status(1), type1_onehot(18), type2_onehot(18)]
#   own_speed               1
#   opp_speed               1
#   opp_move_eff            4
...
NET_ARCH = [512, 128, 64]
LEARNING_RATE = 1e-4
MAX_SPEED = 140  # Electrode is still fastest in Gen 2 randombattle
